...
import np.com.saileshdahal.cryptocurrency.presentation.coin_detail.components.CoinTag
import np.com.saileshdahal.cryptocurrency.presentation.coin_detail.components.TeamListItem
        ...
        state.coin?.let { coin ->
            LazyColumn(
                ...
                item {
                    ...
                    Text(
                        text = "Team Members", style = MaterialTheme.typography.headlineMedium
                    )
                    Spacer(modifier = Modifier.height(15.dp))
                }
